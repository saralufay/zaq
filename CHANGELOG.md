...
## [0.14.0](https://github.com/saralufay/zaq/compare/v0.13.0...v0.14.0) (2026-06-23)


### Features

* **accounts:** gate user portal provisioning behind explicit consent modal ([d1c5f6f](https://github.com/saralufay/zaq/commit/d1c5f6f4582eced542ac803d028a8817e96ec36f))
* **accounts:** provision ZAQ Provider credential on bootstrap onboarding ([870d9cf](https://github.com/saralufay/zaq/commit/870d9cf6f3d5efbb23fa1bdb5433a2208ac7734d))
* **agent:** add Apify MCP endpoint and fix Firecrawl remote URL ([caa4047](https://github.com/saralufay/zaq/commit/caa4047702f40d95d502302ea2d179e10b6eff91))
* **agent:** improve error classification with typed errors, budget exceeded message, and stream error suppression ([09d4f5e](https://github.com/saralufay/zaq/commit/09d4f5e09b7e0ed8fc9ff1ab547bd6fcf8bb4783))
* **agent:** refresh zaq router default model catalog with new llm, vision, and embedding models ([9b2b10c](https://github.com/saralufay/zaq/commit/9b2b10c74208d7fde862460c4e224242534b0fbe))
* **agent:** replace on_status closure with Status.broadcast and gate PromptGuard in Api ([3918dc2](https://github.com/saralufay/zaq/commit/3918dc2bec0ab30b84110391f8c0bc02a5607d7f))
* **agent:** rewire agent pipeline with Status.broadcast, PromptGuard gating, and ChatLive ([7192eb7](https://github.com/saralufay/zaq/commit/7192eb7d3f1b043f0f9e9f864f744446d2f5fbcc))
* **agent:** scope server IDs by channel, add per-agent idle TTL, and inject history context on cold spawn ([2a13c05](https://github.com/saralufay/zaq/commit/2a13c0551cc76e74c91c366def3eacb649af0272))
* **agent:** scope servers per conversation and add per-agent idle TTL and memory context size config ([d9c4f86](https://github.com/saralufay/zaq/commit/d9c4f8634f4bace6b5431a2cc0d667a4cda3f2ac))
* **AI Agent:** wire tool calls to BO livechat and history conversations ([2154caa](https://github.com/saralufay/zaq/commit/2154caa0ecab74be64421c92a62177161248eb87))
* **answering:** provide a tool call to understand the file system ([b2d15b5](https://github.com/saralufay/zaq/commit/b2d15b5871d8d0a4e73b66a016c2be319368c0f3))
* **bo-layout:** migrate sidebar styling to --zaq-* token system ([7ac2041](https://github.com/saralufay/zaq/commit/7ac2041e3301be821ed5702c1ca376b9ad7d5516))
* **BO:** add update badge when a new Zaq release is available ([fb12db2](https://github.com/saralufay/zaq/commit/fb12db23fe8689d09f7018c24119a154d9796dad))
* **BO:** Expose global base url field and use for oauth2 and webhooks ([bf4ba40](https://github.com/saralufay/zaq/commit/bf4ba409ee5635c45e112fc8e5160144ab583d5a))
* **channels:** add datasource bridge and jido connect flow ([9908e95](https://github.com/saralufay/zaq/commit/9908e952e045606e7afedc3026a69e208e411653))
* **Channels:** Automatic webhook ingress management ([4016dda](https://github.com/saralufay/zaq/commit/4016ddade429e8c7d396c78600aae81d988d7222))
* **Channels:** introduce a new upsert_message event with rules to abstract that away from internal ZAQ consumers ([ab000b9](https://github.com/saralufay/zaq/commit/ab000b9daa950367ab393e7570e8beee6df09c6a))
* **communication channels:** define a channel based formatter for outgoing messages rendering ([26f5625](https://github.com/saralufay/zaq/commit/26f5625a78e14c70358c3b194ad4ec1a346d6db5))
* **communication channels:** display an indicator for the ingress status of active channels ([80e7fe5](https://github.com/saralufay/zaq/commit/80e7fe5be63cc93d7f57403db0b18f8e9d9b5872))
* **communication channels:** Telegram (int ID) integration with editable message and tool call registration ([05bd3a3](https://github.com/saralufay/zaq/commit/05bd3a338cf6b633f733100d338758c6852233ab))
* **communication, AI agent:** stream llm response with full trace logging and live rendering ([b1efc03](https://github.com/saralufay/zaq/commit/b1efc03507ca26a7d4eb6b2b87f97e976412a33e))
* **Communication:** standardize capabilities display across channel types ([95c7b10](https://github.com/saralufay/zaq/commit/95c7b105d15b8737e392f591ed8162f2ba6c4b35))
* **Communication:** start wiring up webhooks into communication channels ([51096d7](https://github.com/saralufay/zaq/commit/51096d7671b0867a72d8efd4b05ca21dbbce6d60))
* **Data Source:** add data sources infrastructure and oAuth2 credentials support ([2843fea](https://github.com/saralufay/zaq/commit/2843fea50ca438131c71db2eb43c4e5e8773f47d))
* **Data Source:** adding Actions for data source interactions ([da8b7dc](https://github.com/saralufay/zaq/commit/da8b7dc227162f2e2d3807c76a2b6a6f8f1b5eb9))
* **Data Source:** request permissions with Records ([f11c3ab](https://github.com/saralufay/zaq/commit/f11c3ab59a2e0ef1b60055230753a7637ef171fd))
* **Data Source:** wire capabilities implementation ([a9932ed](https://github.com/saralufay/zaq/commit/a9932edd3793d46056f61b85ad0e4607767dd7a5))
* **Data Source:** wire create and edit docs into new Actions ([72e9a25](https://github.com/saralufay/zaq/commit/72e9a259feb1cb37ef4d6ef63fd4da1e373c762c))
* **DataSource:** Integrate google sheets connector and merge into google_drive Data Source ([a37d122](https://github.com/saralufay/zaq/commit/a37d122a6fb0ffa6c27646935501548b59b89588))
* **design-system:** add gradient border to primary btn, shape tokens, and component styles layer ([82ef3b8](https://github.com/saralufay/zaq/commit/82ef3b8b00da63a9f2c992b62ebaedd582e69042))
* **design:** add zaq-text-* semantic text style classes from Figma ([f602b7b](https://github.com/saralufay/zaq/commit/f602b7b44b054b72e68b4262848e00812ac837fa))
* display notice when trying to add MCP to agent with no active MCP available ([0b0e8c4](https://github.com/saralufay/zaq/commit/0b0e8c4c8f1631faa11ef79017c7b3c83f33188c))
* enable webhooks route in channels ([7186781](https://github.com/saralufay/zaq/commit/71867818183145681ad4a87bff9d74e238eb43c4))
* **engine:** add :get_person engine api handler and update agent/pipeline dispatch to use it ([5407c88](https://github.com/saralufay/zaq/commit/5407c88821a1e7b88b2a0e7fbde42b524ebf9a2f))
* **engine:** add EventRegistry CRUD ops + Workflows sync + Event.new/3 compliance ([42e6aa8](https://github.com/saralufay/zaq/commit/42e6aa8da7eb87d24b6e59e3f4ab182939e11196))
* **engine:** TriggerNode threads event payload into workflow starting node input ([5597daf](https://github.com/saralufay/zaq/commit/5597daf9132f414bd57965328f45b9a981a84856))
* First connection doesn't require login anymore ([81f0494](https://github.com/saralufay/zaq/commit/81f0494671c19d7f01682bb7ab0154f52880fd00))
* implement simplified user onboarding at first login ([e853e59](https://github.com/saralufay/zaq/commit/e853e590534178b10e7324f8156c536fcb108d43))
* **ingestion:** add pluggable fts backend with native postgres default ([121fbb6](https://github.com/saralufay/zaq/commit/121fbb608c0d723bbc71b15e9fe8f81988d9f48e))
* **ingestion:** stream PDF image-to-text progress to BO jobs panel ([c83baed](https://github.com/saralufay/zaq/commit/c83baed5f8bb9fda7f6c12fc868b356303d61916))
* **live:** redirect to ingestion with persistent welcome flash on consent accept ([a5d085e](https://github.com/saralufay/zaq/commit/a5d085e4d3c42cacb405ca621896f034c5aed1c1))
* **live:** show spinner in save changes button during form submission ([3f21ea3](https://github.com/saralufay/zaq/commit/3f21ea361e14ede251beb091a590189537ac2944))
* **onboarding:** add portal liveness gate, dynamic consent copy, and zaq provider fallback ([13ca5a8](https://github.com/saralufay/zaq/commit/13ca5a8902fbb49cb86442954286e609f8a36426))
* **onboarding:** allow email override after 409 conflict in portal activation ([8c1ddec](https://github.com/saralufay/zaq/commit/8c1ddec346b802dacb8cc039f23c39dc22fe0599))
* **onboarding:** portal email sync, network payload, and scenario tests ([43d82fc](https://github.com/saralufay/zaq/commit/43d82fc12481ee5afab729109b2060cec844d21a))
* **onboarding:** pre-provision portal before account creation, add machine-conflict and email-override ([43c3424](https://github.com/saralufay/zaq/commit/43c3424cf4c5b5ca032c0e99847bfb78cd826b78))
* **onboarding:** record portal_registered consent for 409 email conflict ([604092b](https://github.com/saralufay/zaq/commit/604092bd9809dad481c2fa356fe0f48914887b43))
* **onboarding:** replace machine_fingerprint with machine_signals payload and fix update_email arity ([23f0e05](https://github.com/saralufay/zaq/commit/23f0e05f62cffb1f9fd4fba478b51a14642be0a4))
* **readme:** add Discord badge ([06175f1](https://github.com/saralufay/zaq/commit/06175f1e6c60d93ca0db00d9a71774dbda8d2c3e))
* **skills:** add /design-migrate skill for incremental styling migration ([126abfd](https://github.com/saralufay/zaq/commit/126abfde412e28fd7f9af4ba3bd98847a0927af1))
* **skills:** add file write restrictions to design-migrate skill ([7683824](https://github.com/saralufay/zaq/commit/7683824d6064ec88035d2280c58e5619332b273a))
* **skills:** add no-token-for-role annotation and forbidden example to diff format ([0943b63](https://github.com/saralufay/zaq/commit/0943b639aae0a305e7323d48400cb3eeff07b2e5))
* **skills:** add semantic token role-matching rule to design-migrate invariants ([8f3d7cf](https://github.com/saralufay/zaq/commit/8f3d7cfe6f23428486c271db3d74458c31395616))
* **skills:** add targeted e2e verification step to design-migrate skill ([8e9ec67](https://github.com/saralufay/zaq/commit/8e9ec67b2f89681b4abb371945ff64a4e49e888a))
* **storybook:** add button playground, semantic token rename, and btn.css ([631efd7](https://github.com/saralufay/zaq/commit/631efd7270ee61669a131ba54e9e23c12e4067d1))
* **storybook:** add component stories for BoModal, ChannelIcons, IconRegistry, MasterDetailLayout, and SearchableSelect ([58e5d7d](https://github.com/saralufay/zaq/commit/58e5d7db325a61cb2590757b0d36079dc45464b5))
* **storybook:** add foundations/palette story with raw CSS variable swatches ([2aba2dc](https://github.com/saralufay/zaq/commit/2aba2dcfb9fb6b3d3a9cdea880a27f42be8afac4))
* **storybook:** add foundations/spacing and foundations/typography stories ([06e5f8f](https://github.com/saralufay/zaq/commit/06e5f8f4f146be43a98689d2f56259686454be3e))
* **storybook:** add icon + icon-only button variations to playground ([8cffb5c](https://github.com/saralufay/zaq/commit/8cffb5ce69decea84880cd1b913c8bfb38f926aa))
* **storybook:** add line-height and letter-spacing token rows to fonts story ([31da8f6](https://github.com/saralufay/zaq/commit/31da8f610e4724c23a5a7f985373ca826db8f04a))
* **storybook:** add Text Styles page to Semantics using zaq-text-* classes ([d6cafaa](https://github.com/saralufay/zaq/commit/d6cafaab720c9c1254da50c2b128ce1506e51862))
* **storybook:** move colors/borders/shadows into new Semantic section ([0b0bc1e](https://github.com/saralufay/zaq/commit/0b0bc1e33365a04444cb21837a650d5829c3187a))
* **storybook:** reorganize stories into categorized sections with semantic tokens ([cc1fe1a](https://github.com/saralufay/zaq/commit/cc1fe1a843588674fffd7aac1173928f5e64bdc9))
* **system-config:** restore auth credential actions and rename tabs ([71c5799](https://github.com/saralufay/zaq/commit/71c5799d868927a9350c7cb9fe25855b53c5f864))
* **system:** persist machine fingerprint to file for stable identity across restarts ([ad6b026](https://github.com/saralufay/zaq/commit/ad6b0269c35e5aa2f09ff27ef3d1c9d9c4ceb3ae))
* **web:** add icons to gear settings dropdown menu items ([4ac1aaa](https://github.com/saralufay/zaq/commit/4ac1aaaf35808846438bba7f487eb7a9a2c23c9c))
* **workflow:** add contract to maintain on_success and on_failure path for the workflow ([b58a8da](https://github.com/saralufay/zaq/commit/b58a8daea80d499e9c553f5ce24c27185dae0842))
* **workflows:** add structured log storage to workflow step runs and email tools ([2b18822](https://github.com/saralufay/zaq/commit/2b18822e29f6782aea22796a5610a5d3b1375309))
* **workflows:** data model — zaq-3ux ([0583557](https://github.com/saralufay/zaq/commit/05835573b7a3501793ea22d189c9ea163693b50f))
* **workflows:** make workflows runnable from DB — zaq-3ux ([ba8226d](https://github.com/saralufay/zaq/commit/ba8226d571ef2fec9af1b438c9de2cd2643eb80d))
* **workflows:** move into engine namespace, rename ActionResult to StepRun, add structured logging with ([c8ad192](https://github.com/saralufay/zaq/commit/c8ad1925005ace4d190eee3434427d5f44c97148))
* **workflows:** replace raw steps map with typed StepNode/StepEdge embedded schemas ([bd243f4](https://github.com/saralufay/zaq/commit/bd243f42585dec104f4a75bc7fcb87f9d1e7b49c))
* **workflows:** replace trigger system with event-driven NodeRouter/PubSub architecture ([018a27d](https://github.com/saralufay/zaq/commit/018a27d6a2cd839c7a3319b9bc98f3fc7581d30c))
* **workflows:** wire DB-stored runs to Runic execution with ActionResult tracking, fix condition ([c6120d7](https://github.com/saralufay/zaq/commit/c6120d708f178eb332dbb6411af169a9edec0d75))


### Bug Fixes

* **agent/channels:** update tests for async from_listener and derive_scope/2 refactor ([9ec10ff](https://github.com/saralufay/zaq/commit/9ec10ff696bf41e9b4f19081e7cd77d3eb93d501))
* **agent:** centralize pipeline error messages across channels and add error message tests ([4f3c5df](https://github.com/saralufay/zaq/commit/4f3c5df4b895c8a003a766ec681bb9c847892d8c))
* **agent:** default to openai/gpt-oss-120b and disable unavailable models ([945e279](https://github.com/saralufay/zaq/commit/945e27982aaa3fe1641d8dfe2294676c4181b324))
* **agent:** enforce tool calls for listing queries, fix no-permission doc access, and hardcode answering ([056ffca](https://github.com/saralufay/zaq/commit/056ffca6b538a01b833974c55b723aa63e7015da))
* **agent:** handle history ([9787f99](https://github.com/saralufay/zaq/commit/9787f9921659dff5d51a40254c874018db530b5c))
* **agent:** max iterations ([b5187af](https://github.com/saralufay/zaq/commit/b5187aff3b833eafd924317025d2a5d900cccc5c))
* **agent:** replace list_knowledge_base_files with knowledge_base_overview, enforce tool_choice, fix ([36cc077](https://github.com/saralufay/zaq/commit/36cc07753f63a96aa65579ef8d402ffd476f8a58))
* **agents:** cover it with e2e tests ([1bbcf84](https://github.com/saralufay/zaq/commit/1bbcf844f1b9b8a73efe19835df2adb71d769228))
* **agents:** display stale tool keys with Removed badge and unblock editing ([abe8270](https://github.com/saralufay/zaq/commit/abe827042a79250b3194a2be719eecc7fe4b7826))
* **agents:** fix OpenRouter case mismatch and add full E2E coverage ([8a22216](https://github.com/saralufay/zaq/commit/8a2221667fea94fbdbbd44b0b2231fb4ffef4a37))
* **agents:** scroll to flash/inline errors after DOM reflow using requestAnimationFrame ([4424f6e](https://github.com/saralufay/zaq/commit/4424f6e240a7756f6060e550448d4127485f1bef))
* **agent:** stop using patch for max_iterations ([613302e](https://github.com/saralufay/zaq/commit/613302edd17be75946a6be4e0365c28d48e3ea4c))
* **agent:** surface provider errors instead of empty bubbles and add title fallback ([2637d66](https://github.com/saralufay/zaq/commit/2637d66ed3b4e2a08f8d74a7d7d597d61afb7514))
* **agents:** when error occurs on agent page it scrolls for user to know what's the error ([2f8e183](https://github.com/saralufay/zaq/commit/2f8e1832a8fd3187d11c06785712d4419f1df1b8))
* **AI agent:** correctly collect token usage measurements in messages and in dashboard telemetry ([5fa7373](https://github.com/saralufay/zaq/commit/5fa737338dbe35243f882347888ceeb69da7ab2f))
* **AI Agent:** increase Executor call to factory.await/2 timeout to match the config in factory module ([4befb57](https://github.com/saralufay/zaq/commit/4befb57fdc52facb6f66b7ab9cc0591481be238e))
* **AI Agent:** system prompt refresh logic ([d5727ea](https://github.com/saralufay/zaq/commit/d5727ea793cb871a6e7abb3366adb1d428f5e05e))
* **bo:** add bulk delete for people with selection, confirmation modal, and gateway ([e79fbda](https://github.com/saralufay/zaq/commit/e79fbda6df9b7d02c6c76fc7be1e829054be8c4a))
* **bo:** address bulk-delete review findings — transactional delete, unified confirm bar, key normalization ([7e49cce](https://github.com/saralufay/zaq/commit/7e49cce3bdb49be594e1b7b9fd41e8b8f5ce575f))
* **BO:** correctly assign trace field type in migration, remove storybook from coverage ([7eb1f40](https://github.com/saralufay/zaq/commit/7eb1f408ee609e0515f9e49b62ffd0dc76dab6dd))
* **channel:** add incoming context to executor path ([dd64e32](https://github.com/saralufay/zaq/commit/dd64e3214186b32f6582df10a2bb830d07cd1049))
* **Channels Config:** generalize Send message through NodeRouter ([f1ad3af](https://github.com/saralufay/zaq/commit/f1ad3af16a117739a6d00edce24a8539978e23ff))
* **channels:** display capabilities for all available channels (even if disabled or not configured) ([ffc9118](https://github.com/saralufay/zaq/commit/ffc9118375e6241c0407e4160201c257cbcebf2a))
* **channels:** display errors on BO on gateway failures ([75399f4](https://github.com/saralufay/zaq/commit/75399f410f079194e6893c4862689ce05edd2840))
* **channels:** normalize configs to ensure tokens are decrypted ([39f45ac](https://github.com/saralufay/zaq/commit/39f45ac21f7b25a2e4fee16b4a43d367d33577db))
* **chat:** add delete chat confirmation modal and new_chat event ([f748618](https://github.com/saralufay/zaq/commit/f748618f67c4d39f2a2a897c29216278a8976084))
* **chat:** delete chat button ([f0b0dc3](https://github.com/saralufay/zaq/commit/f0b0dc37a330370ed75a0ff13d8999abd4c726da))
* **chat:** rename clear-chat to new-chat button and fix e2e selector ([1f937fe](https://github.com/saralufay/zaq/commit/1f937fe52f403ebd119933b16637034921fa7fb6))
* **ci:** add a summary for the releases ([7762b3f](https://github.com/saralufay/zaq/commit/7762b3f1790877a53ff89e402ba62fd649df932b))
* **ci:** compile into _build/test-e2e to eliminate double Elixir compilation in E2E workflow ([2b1290f](https://github.com/saralufay/zaq/commit/2b1290f42a26904627e637940fdf3c6882e18097))
* **ci:** grant statuses:write to test job so Coveralls can post coverage status back to GitHub ([5924d4a](https://github.com/saralufay/zaq/commit/5924d4ae93e0f934a9fbd4f9d4dcef32065c6d3c))
* **CI:** storybooks e2e exclude from ci ([8b74e1a](https://github.com/saralufay/zaq/commit/8b74e1a903d558b61b999ec7f6a63c33c843d586))
* **communication channel,imap:** strengthen ssl management and harden flaky tests ([36bf63a](https://github.com/saralufay/zaq/commit/36bf63a571f828c22f62bbc0251d7ddaaedcb4fd))
* **communication channels:** deliver_outgoing :ok response handling ([e85ad16](https://github.com/saralufay/zaq/commit/e85ad1662c0eb9229054161f35bcfb4540c4538f))
* **Communication:** send_typing fix for non binary channel_id (i.e Telegram) ([f16a2b3](https://github.com/saralufay/zaq/commit/f16a2b3e2e635bd25693b4135743a5ac506ade58))
* **config:** make dev.secret.exs import conditional to unblock CI ([2081ad9](https://github.com/saralufay/zaq/commit/2081ad961bc38438c7349bf1aa40e058981a7db3))
* **config:** make dev.secret.exs import conditional to unblock CI ([a64a8f9](https://github.com/saralufay/zaq/commit/a64a8f97cdd7222382eba99c50233913c1cfd773))
* **data source:** support jwt_bearer (service account) in auth credentials, implement for google drive ([1bd1c5a](https://github.com/saralufay/zaq/commit/1bd1c5a7d9ef068b0df0cc9aaac828055e513606))
* do not start the app if the SYSTEM_CONFIG_ENCRYPTION_KEY is not provided ([cc196c7](https://github.com/saralufay/zaq/commit/cc196c71f5ce791826eeac02c14bc638da3197e4))
* **e2e:** pin Storybook server to PORT=4000 MIX_ENV=dev to avoid port collision with test server ([a71aa73](https://github.com/saralufay/zaq/commit/a71aa732c445e13e61967c878f01a98fa4899a59))
* **e2e:** stabilize remove-MCP test by waiting for modal close ([17a44e3](https://github.com/saralufay/zaq/commit/17a44e3209303ae93e58700606561fd502084b52))
* **engine:** defer EventRegistry trigger load to handle_continue and make isolate_event_registry ([f0b28e8](https://github.com/saralufay/zaq/commit/f0b28e82ddfb620e0bd558b2d5258fb1a287b881))
* **engine:** EventRegistry.list_events/2 returns map instead of list ([f750415](https://github.com/saralufay/zaq/commit/f750415e4b9dce00ff73df9c5f28cb30fe4fd129))
* forward telemetry dimensions through agent pipeline and increase ask timeout to 300s ([c8b958a](https://github.com/saralufay/zaq/commit/c8b958a029586f33fa178495f6531e10bc2c4082))
* **foundations:** add unit to --letter-spacing-relaxed (1.0 → 0.1em) ([156f58c](https://github.com/saralufay/zaq/commit/156f58cc80feed42250097b48007e07aa037135e))
* **ingestion:** activate paradedb on fresh installs via probe-driven setup ([946f783](https://github.com/saralufay/zaq/commit/946f783448492a19c3524936b4f17b494a074209))
* **ingestion:** allow cancelling processing jobs and stop pending chunk workers ([33f800c](https://github.com/saralufay/zaq/commit/33f800c70e7a6b5ad03946da54f9f9ae48c8917c))
* **ingestion:** atomic stop_job, race guard, friendly error messages, and embedding settings link ([88f68ae](https://github.com/saralufay/zaq/commit/88f68aea1a8e185e32f25c2d6e703771812f1a32))
* **ingestion:** base ingested status on chunk existence instead of DB record presence ([68c4ff8](https://github.com/saralufay/zaq/commit/68c4ff8d319830f5a30c1bbd71860bafaec3dbde))
* **ingestion:** cancel stuck jobs, stop chunk retries, and surface fatal errors to the user ([b5b39c5](https://github.com/saralufay/zaq/commit/b5b39c5614c0272337547f7eb2eacbf64bd043cf))
* **ingestion:** case-insensitive @ mention suggestions and rename regression tests (issue [#330](https://github.com/saralufay/zaq/issues/330)) ([0bdae1c](https://github.com/saralufay/zaq/commit/0bdae1cb28da36d264a84b7f0244b46904879667))
* **ingestion:** clean up orphaned document records when deleting a folder ([fb05282](https://github.com/saralufay/zaq/commit/fb05282de5ed1048f5efcfcf765630067ebae63a))
* **ingestion:** detect paradedb via functional probe and split fts ci ([8d76581](https://github.com/saralufay/zaq/commit/8d7658166baf4bf09abd6675f774c3f4300b9439))
* **ingestion:** detect sidecar .md files by filesystem name matching instead of DB lookup ([a85b92d](https://github.com/saralufay/zaq/commit/a85b92df70f146cfb8a2bc65b9b0f0f52211563f))
* **ingestion:** handle folder drops with batching, relative paths, and in-progress upload guard ([d68d554](https://github.com/saralufay/zaq/commit/d68d554875fc1b6e244cfea5a2514da7ff1362f3))
* **ingestion:** handle legacy absolute-path sources in rename, delete, and upload tracking ([f64ad99](https://github.com/saralufay/zaq/commit/f64ad99b46bf55f9a1c533d6b77e6c3780bb875d))
* **ingestion:** include no-permission-rows docs as public by default in list_accessible_documents ([0617ae4](https://github.com/saralufay/zaq/commit/0617ae4a4a6efee23a81f0c4861ee9c2a421707a))
* **ingestion:** keep dotted literals matchable in BM25 search ([30c9512](https://github.com/saralufay/zaq/commit/30c95125e5498ed6b810e7682c8c3ec21641b483))
* **ingestion:** keep paradedb detection from aborting open transactions ([234d246](https://github.com/saralufay/zaq/commit/234d246b69bcb622b97a73ac19c629f493a83522))
* **ingestion:** preserve document headings by storing chunk title separately ([37ad45e](https://github.com/saralufay/zaq/commit/37ad45eedd8388b735ffc2454fb9318ac16d3315))
* **ingestion:** prevent track_upload from wiping ingested content on re-upload ([d92d29b](https://github.com/saralufay/zaq/commit/d92d29b0d53c935e57434e132d7d29eaa5091634))
* **ingestion:** readEntries error handling, queue cleanup on destroy, skipped reset on upload, path tooltip, event doc ([a1da0d2](https://github.com/saralufay/zaq/commit/a1da0d23cdf32c4529150ef7e2f1aac5e1763772))
* **ingestion:** redact malformed progress lines and clamp prep indicator ([1bffa51](https://github.com/saralufay/zaq/commit/1bffa512cb11e83f6d5164b75932c1b60ef5c069))
* **ingestion:** rename tool and reject side car count ([43799da](https://github.com/saralufay/zaq/commit/43799da25c6deb446236fcc4fa5fad09a5462b85))
* **ingestion:** replace manual FS rollback with Sage saga and fix metadata fragment cast ([e914179](https://github.com/saralufay/zaq/commit/e9141794a6c9524dd8f699a2bd901d466f53f75a))
* **ingestion:** solid sanitize_bm25_query — fix Unicode whitespace and idempotency ([01e6f55](https://github.com/saralufay/zaq/commit/01e6f55f600c792d0e70b7713207a908c3cd38c8))
* **ingestion:** volume base_path with default at volume base root ([dfced0e](https://github.com/saralufay/zaq/commit/dfced0e5cfca6c8b260fa9174efc0a04b2c38dd9))
* **ingest:** update document sources and sidecar metadata when renaming a folder (issue [#331](https://github.com/saralufay/zaq/issues/331)) ([98a5456](https://github.com/saralufay/zaq/commit/98a5456195448f64f7f28a262ff9983abf7ea789))
* **live:** bypass req.test plug in e2e bootstrap to unblock dashboard moun ([3f57db8](https://github.com/saralufay/zaq/commit/3f57db815f42639af43a1b5ebd86b7fc04c82b8e))
* **live:** correct prep progress stage labeling and gate active prep jobs in O(1) ([a9065e1](https://github.com/saralufay/zaq/commit/a9065e1c93a55069229be925c1397418c8703f5e))
* **live:** prevent stale ingestion prep indicator on retry, straggler, and orphaned jobs ([f3b4151](https://github.com/saralufay/zaq/commit/f3b4151ae6255c0c19285845955592566c1ba95f))
* **live:** replace flash redirect with post-accept modal on portal consent ([339e648](https://github.com/saralufay/zaq/commit/339e648cd9d1bdac4e7a8979836592dcecb7d3d9))
* **live:** surface error outgoing to replace empty streaming bubble ([bb8d143](https://github.com/saralufay/zaq/commit/bb8d143e4ca51e254587625f6cf05d7249982a55))
* **llm_db:** pre-create modality atoms before snapshot load to match LLMDB.Application boot contract ([195575c](https://github.com/saralufay/zaq/commit/195575ce93e822b25b65033ef591ab6e85ce5dc4))
* **llm-config:** remove json_mode and logprobs also enforce user to pick models have tools enabled based on llm_db ([b060fd5](https://github.com/saralufay/zaq/commit/b060fd5cc026d5d5ded5e42cc97877c720a5ed24))
* **mattermost:** indicate bot should join a team, support private, dm and grouped dm channel types ([891d3d1](https://github.com/saralufay/zaq/commit/891d3d1f744532eee40816b32e101952a5450c56))
* **mcp:** enable context-awesome in MCP directory ([f8fde48](https://github.com/saralufay/zaq/commit/f8fde4863a30338fbbf585960954c4f5f075ae6a))
* **MCP:** enable firecrawl and tweetsave MCP now working with jido_mcp ([99ee44f](https://github.com/saralufay/zaq/commit/99ee44f648a192b67aaf605ebeb065cf892fe763))
* **onboarding:** add email to user consent popup ([71be075](https://github.com/saralufay/zaq/commit/71be07522d1bc2ea678c64ef4fc9a053ebf7762d))
* **onboarding:** atomic bootstrap provisioning via sage, nil endpoint default ([d10aa4e](https://github.com/saralufay/zaq/commit/d10aa4ec3948f71667535746fae4f8aef316d4fe))
* **onboarding:** load portal consent banner async and drop machine fingerprint ([fa12c70](https://github.com/saralufay/zaq/commit/fa12c70109aa9bffa639e641e92c638cb2a8aef7))
* **onboarding:** scaffold zaq router credential on retry 409 conflict ([b8464e1](https://github.com/saralufay/zaq/commit/b8464e1eac22bb096bf785047c020723a99b289d))
* **onboarding:** surface portal errors, dedupe requests, offline router ([83cc619](https://github.com/saralufay/zaq/commit/83cc619e0eda14ab921da9eebf91331fd8fa1348))
* **People:** no people creation for BO messages ([a611f83](https://github.com/saralufay/zaq/commit/a611f83be59e97164e57d1d8f9336d8dd8f5898c))
* **quality:** add git_hooks and mix quality ([5bd2330](https://github.com/saralufay/zaq/commit/5bd23302f8e2c4289277dc717fea99173bea4a78))
* reconnect metrics to dashboard ([9a91ea6](https://github.com/saralufay/zaq/commit/9a91ea6864d5f6f030864254d59fe181e4272fbb))
* **release:** fix llm_db dep ([5eb4a36](https://github.com/saralufay/zaq/commit/5eb4a36489d00fb2e4ce2f289de6c811e0d708b1))
* resolve merge conflict in config/dev.exs, apply storybook config changes ([5f3bf3d](https://github.com/saralufay/zaq/commit/5f3bf3dea2b536343f75393403d2477400eb27d9))
* restore configs ([edd5151](https://github.com/saralufay/zaq/commit/edd515118ed852993e6653ec33a3b774e243c88a))
* **retrieval:** remove prompt template and make it hardcoded ([e381251](https://github.com/saralufay/zaq/commit/e38125142c150a07bb7cc7b26db8c5b0ae0b736b))
* **retrieval:** replace JSON-mode output with markdown parsing in retrieval agent ([d698b21](https://github.com/saralufay/zaq/commit/d698b21afba750cc9494e750cf8c189f849dd527))
* **skills:** add batching section to design-migrate skill ([eed021f](https://github.com/saralufay/zaq/commit/eed021ff5a224e11cf36d3418ac7c667c4a4d8a7))
* **skills:** add timing column to file write restrictions to prevent premature component edits ([c3c32f0](https://github.com/saralufay/zaq/commit/c3c32f0f68c28b85efa31e192d58c947e9e5d707))
* **skills:** address quality review findings in design-migrate skill ([b75f2d7](https://github.com/saralufay/zaq/commit/b75f2d70c3a066f1f4fdcd17cf120dd3198b9291))
* **skills:** convert design-migrate to directory structure (SKILL.md) ([08702e9](https://github.com/saralufay/zaq/commit/08702e9d4a723e873d12f5230a5109dc740a1d36))
* **skills:** replace 'app template' language with explicit file allowlist in Step 4/5 ([99cc6f4](https://github.com/saralufay/zaq/commit/99cc6f4e468c08e8760d39c6867544fca5a95020))
* storybook toggle switch dark mode ([a63fbce](https://github.com/saralufay/zaq/commit/a63fbce96ac282ca1e41d99e95488428552559b7))
* **storybook:** add missing surface-dark swatch to semantic colors story ([8b7758a](https://github.com/saralufay/zaq/commit/8b7758af18209912f5abefbf3183f1e4073e8227))
* **storybook:** convert index.exs to PhoenixStorybook.Index modules for correct sidebar ordering ([f9a7b9e](https://github.com/saralufay/zaq/commit/f9a7b9ec32202f5b0894606c5de81c4733a0f683))
* **storybook:** convert layouts index.exs to module format and set folder_index 4 ([27e3938](https://github.com/saralufay/zaq/commit/27e39382f988597eab1080222aea53a8e951a663))
* **storybook:** correct font token labels to --zaq- prefix ([4290762](https://github.com/saralufay/zaq/commit/42907622544e72f394e98dd46ed3fe6a734bfb10))
* **storybook:** escape HEEx {@ expressions in code display blocks ([948dd3b](https://github.com/saralufay/zaq/commit/948dd3bac90b1bc781de3788ec6d8e3a3919a7cf))
* **storybook:** fix 5 stories that failed the smoke test ([3487358](https://github.com/saralufay/zaq/commit/34873581e3247f06cc091843be1c7c523815dc9c))
* **storybook:** fix gitignore, reuseExistingServer CI safety, restore heroicons sparse, revert storybook version bump ([4403147](https://github.com/saralufay/zaq/commit/4403147d84ac7451aeaa150819cb266a02940af7))
* **storybook:** isolate ZAQ dark mode from DaisyUI via data-zaq-theme attribute ([4be4e0a](https://github.com/saralufay/zaq/commit/4be4e0a4e56598fcc1e2e5c83236580be618fd8c))
* **storybook:** pin Welcome to first position in sidebar via root .index.exs ([b2be326](https://github.com/saralufay/zaq/commit/b2be3266901141218d105c8a9eabcea24bd36ab0))
* **storybook:** poll for server readiness in globalSetup, commit story-urls sentinel ([299be81](https://github.com/saralufay/zaq/commit/299be813b85b6bbf676e0369dddb887210dbc0c4))
* **storybook:** prevent large scale bar overflow, update description ([94ef1e8](https://github.com/saralufay/zaq/commit/94ef1e8b581633f5f6a1efdd370b9b4be52d1dfc))
* **storybook:** rename index.exs to .index.exs so PhoenixStorybook detects folder index modules ([0944daa](https://github.com/saralufay/zaq/commit/0944daaa90fdabe3530d4dd8af3e8ff4ecdee017))
* **storybook:** replace .dark class shim with psb → data-theme dark mode bridge ([61744c7](https://github.com/saralufay/zaq/commit/61744c7a92806c2f5ed561c3a5902805b3725ec7))
* **storybook:** replace &lt;&gt; sigil sample in text_styles story to fix HEEx compile error ([6fed9f9](https://github.com/saralufay/zaq/commit/6fed9f9245e6004ee14e6081d46448fc0c0677c6))
* **storybook:** replace hero-plus/arrow-down-tray with icons already in Tailwind output ([1c0a744](https://github.com/saralufay/zaq/commit/1c0a74459518e049d8c76b9ad9fb8a6d29bdebfb))
* **storybook:** replace legacy --zaq-font-primary with --zaq-font-family-body in colors story ([306ea84](https://github.com/saralufay/zaq/commit/306ea84d2ffd006378e0b8988bf2b24e90a56294))
* **storybook:** update spacing story to --zaq-scale-* token names, add missing scale tokens ([c25312b](https://github.com/saralufay/zaq/commit/c25312b3e60b34ee4d801c0068acee81cecd35dc))
* **storybook:** use blue-400 for scale bars, fix overflow on large tokens ([1f8f427](https://github.com/saralufay/zaq/commit/1f8f42700d377adc02d8388807b0b58901da09f3))
* **storybook:** use filesystem discovery to find all stories, fix webServer url redirect ([2ef4f94](https://github.com/saralufay/zaq/commit/2ef4f940044557b4887a6877e3ed407ba613ebec))
* **storybook:** use globalSetup for story discovery to fix empty test registration ([2e3d673](https://github.com/saralufay/zaq/commit/2e3d673dc3617a5ff104894c1ed1a786b10e2276))
* **storybook:** wrap poll context in try/finally, skip final sleep on last attempt ([74de0e5](https://github.com/saralufay/zaq/commit/74de0e591538d97b50a791f2c2a0ebc8f49a6535))
* support async EventHop types in NodeRouter.dispatch/2 ([a649325](https://github.com/saralufay/zaq/commit/a649325dda2c6efcb8cb40d69bc6a7850f3615c7))
* **test:** resolve module name collision and fix StepRun.statuses assertion ([ee2e4cc](https://github.com/saralufay/zaq/commit/ee2e4ccfdccbe90ede66907c5d1b6977035daf4e))
* **tests:** eliminate port race in OpenAIStub and fix precommit failures ([eb2e799](https://github.com/saralufay/zaq/commit/eb2e799988141e29c1f3eb2d2b074e51b883c1db))
* **web:** restore tool_calls_popin component dropped in merge ([9ba1534](https://github.com/saralufay/zaq/commit/9ba15349cf2df2f2c63a8ea1ede6d5546fa86193))
* **web:** validate email format in portal consent modal ([623b489](https://github.com/saralufay/zaq/commit/623b489ccfc1c20d58dbbb4ee31cfa25b8971292))
* **workflow:** creating and updating trigger sync the event registery ([298ce92](https://github.com/saralufay/zaq/commit/298ce9233e3e19ee990fc06fc1eb88d13a8dd66d))
* **workflow:** make event registry fire async and event name coupled with destination ([fa9b0ac](https://github.com/saralufay/zaq/commit/fa9b0acd16b6b3896b0bdb91362ba98078b7c9f9))
* **workflows/permissions:** address all PR review findings ([aadb282](https://github.com/saralufay/zaq/commit/aadb28288d5e2d834dc12f837b88a3827f0f6b92))
* **workflows:** auto-set started_at in create_action_result/3 ([c7431fa](https://github.com/saralufay/zaq/commit/c7431fac35052dcdfdda33ad23d1088f4f8c7204))


### Performance Improvements

* **channels:** only load ingress status indicator for active channels, allow deleting config with missing webhook ingress sub ([e49a0ac](https://github.com/saralufay/zaq/commit/e49a0acfe5928fde9a446c61fcd25302149079ee))
* **communication channels:** non blocking channel status load, non blocking formatting error ([8a38789](https://github.com/saralufay/zaq/commit/8a38789d3472454a436d0fa00f43eb1e46a924c2))


### Refactoring

* (BO) chat shell layout and animation styles into a common css page ([dfd9302](https://github.com/saralufay/zaq/commit/dfd93024615d184b0445ccd2387f0f40d96e0e21))
* (BO) design migrate theme toggle in header ([33b6ef2](https://github.com/saralufay/zaq/commit/33b6ef21602210406c5528ba8b20b28bddfd7766))
* (BO) design migrate transcript component in chat page ([4fe0790](https://github.com/saralufay/zaq/commit/4fe0790fa3cc12987e138225d066cb1d9a3edf76))
* (BO) design migrate user bubble in chat ([602ae00](https://github.com/saralufay/zaq/commit/602ae009caa1932208378dd9b44a4ff46e56c538))
* (BO) design migration and unification of component upsell card ([32fafe1](https://github.com/saralufay/zaq/commit/32fafe1d81dc743740c1637173d4581366eccf64))
* (BO) design migration chat history sidebar ([6b48979](https://github.com/saralufay/zaq/commit/6b48979e90f00f5a0f12fd85a22345860abbc174))
* (BO) design migration composer element in chat ([ac9623f](https://github.com/saralufay/zaq/commit/ac9623f4d64fe393ea116522a41dcdd9c8bdf8a9))
* (BO) design migration for the ingestion list view (table) and fixing grid doc in storybook ([e17c270](https://github.com/saralufay/zaq/commit/e17c2705ce6fd5b7bd6cd63badb52ff7a9246c23))
* (BO) design migration grid view - ingestion page ([39a2cbd](https://github.com/saralufay/zaq/commit/39a2cbda72b0232d69658aa5cf26db126002faf3))
* (BO) design migration header of chat ([58f4e17](https://github.com/saralufay/zaq/commit/58f4e1757a5fff813dd7ce791251bd5d50a11418))
* (BO) design migration of assistant bubble component and use cases ([4546f9d](https://github.com/saralufay/zaq/commit/4546f9dc1214fc29aca7f4dbeea53e744e7266cb))
* (BO) design migration of suggested prompts in chat page ([ca8001a](https://github.com/saralufay/zaq/commit/ca8001a9709d86a9a7e677a1257badbd625ee4f0))
* (BO) extract all components from Ingestion page ([4cc4416](https://github.com/saralufay/zaq/commit/4cc4416938c9b803872dc3cb6ef2f07ed49fd249))
* (BO) extract components from chat page ([14d6e35](https://github.com/saralufay/zaq/commit/14d6e35a3c456700e37dc787682f4d93654c0e5b))
* (BO) extract components from History page ([734345e](https://github.com/saralufay/zaq/commit/734345ea62c9a8a57b5911c9331afb1891e63a36))
* (BO) hiding button preview from grid in ingestion ([446959f](https://github.com/saralufay/zaq/commit/446959f25163324973ad3b02bc3c41da31c61cff))
* (BO) migrate design of component dropzone ([0498f39](https://github.com/saralufay/zaq/commit/0498f391e37ff489a6dfd199ed7e9f18523dadbe))
* (BO) migrate design of status badge used in dashboard ([d987d4c](https://github.com/saralufay/zaq/commit/d987d4c7e911caf0fb095e8c282ed3b1a5d10692))
* (BO) Modal file preview UI migration - Ingestion ([db97064](https://github.com/saralufay/zaq/commit/db97064648a3d341b18ecfcccb7b04e6323a484a))
* (BO) status pill ui design migration ([21a1058](https://github.com/saralufay/zaq/commit/21a10585110aabbafaac4b1078e2886b571dc216))
* (Storybook) adjuste stories of thumbs up/down/copy to show on assistant bubble ([f7619d7](https://github.com/saralufay/zaq/commit/f7619d7401a86cb4fbddff3f222130e64671c3c4))
* (Storybook) fix dashboard service status table ([0140ae7](https://github.com/saralufay/zaq/commit/0140ae7c08e124cdc6db126bffff615149f89e49))
* (Storybook) reorganising story documentation ([7ba4ee5](https://github.com/saralufay/zaq/commit/7ba4ee5e9cddf3c41ed31c779a642f2af7945522))
* **accounts:** move portal provisioning into UserPortal.Onboarding boundary ([e1f5767](https://github.com/saralufay/zaq/commit/e1f5767b7b2e152aa8987cecd2557a05a40eaae2))
* adjust code to avoid crashes from the new badge component ([dfca395](https://github.com/saralufay/zaq/commit/dfca39508b4783749e32e92034bbaa1daba995d9))
* **agent:** clean server manager and executor from history context and move it to factory ([11cf36a](https://github.com/saralufay/zaq/commit/11cf36aea3705a6e5226bc1289a653890d22c43b))
* **agent:** move history loading out of ServerManager into Executor, with HistoryLoader owning routing ([facd1ef](https://github.com/saralufay/zaq/commit/facd1effbb867993f7160a1e9a79dd43d94979bb))
* **agent:** remove AgentController, its routes, and dead prompt-guard output check from pipeline ([b3c156a](https://github.com/saralufay/zaq/commit/b3c156a0ba63462d3c6373c6b75c0a124fdb7b84))
* **Agents:** define an Error.format helper to use accross tools ([7eeadd6](https://github.com/saralufay/zaq/commit/7eeadd6e02ebebfba7cf21618634c9504d142820))
* **Agent:** Simplify data source tools code ([c094399](https://github.com/saralufay/zaq/commit/c0943992211850cf54c9da194da80c8d7a224fc7))
* **AI Agents:** Properly wire Agent server hot patch/shutdown strategy when config values change, harden new history loading selection extraction. ([f7ee723](https://github.com/saralufay/zaq/commit/f7ee7231104710c02b70c4b654b07c579b12f1dc))
* **answering:** conversation_enabaled true so communication channel can use answering agent. ([20cea28](https://github.com/saralufay/zaq/commit/20cea2869e40ffe2d4c2b44e8e372e1a4ea01007))
* **auth credentials:** multiple config management per data source ([9ed4f31](https://github.com/saralufay/zaq/commit/9ed4f31a11993c1e2a603b24f34bd7e28307b9f7))
* **BO:** split the system config tabs into specific components ([e4cd26f](https://github.com/saralufay/zaq/commit/e4cd26f61a6c7d9fa5dbf4050b787e3e4ef7716f))
* bump jido_ai deps and align agent selection in channels ([bd9cd09](https://github.com/saralufay/zaq/commit/bd9cd0997bb62757a5cbd415c23891dc4288a00f))
* **Channels:** adjust code path for code quality and upsert feature standardization ([2149b95](https://github.com/saralufay/zaq/commit/2149b95915106233644763b21d52bb207e7e29b1))
* **channels:** align BO livechat with new Event passing logic, unify error management ([830fdbf](https://github.com/saralufay/zaq/commit/830fdbfc9bb622fb00a801463b570e0401f6452d))
* **channels:** implement a process to monitor supervised listener and surface errors if any to feed listener status indication ([30deb94](https://github.com/saralufay/zaq/commit/30deb949691039aea5c767f71ac3faed8afa5338))
* **channels:** node route dispatch chains multiple hops, leverage noderouter on Agents and Zaq -&gt; Channels node calls ([2635ed8](https://github.com/saralufay/zaq/commit/2635ed81663c3a48cef1dd1e0591b74e5bdee959))
* **channels:** restore capabilities granularity and future proofing synthetic config ([2c4a1ea](https://github.com/saralufay/zaq/commit/2c4a1ea5f24c346aa95b2f51d1c44b29cfcf0f5a))
* **channels:** restructure bridge behavior and split Zaq technical domains from communication domains ([a03ee66](https://github.com/saralufay/zaq/commit/a03ee661682485c2734866d30f6cb7eb374a4e43))
* **channels:** route channel delivery through API event boundary ([dba6162](https://github.com/saralufay/zaq/commit/dba61623d81fa8fd24b9b544d5886bc2afd42f80))
* **Channels:** Run webhook verification sync then enqueue Data Source webhook in Oban for async process ([df298b3](https://github.com/saralufay/zaq/commit/df298b382d249a6b62c3a305995ad58bbaef8d86))
* **Channels:** wire messages to new upsert_message feature ([2ba875e](https://github.com/saralufay/zaq/commit/2ba875ec364018a0dedb7b232f345bda408c0352))
* code organization ([10ba1d8](https://github.com/saralufay/zaq/commit/10ba1d8e42bcb4c67d832c41c0dc80fa5bcfb091))
* **connect:** normalize scope parsing and document sync jwt refresh ([42473d4](https://github.com/saralufay/zaq/commit/42473d479a1541fccb2156d277862dd70600f19f))
* correctly wire ctx in jido telemetry event to broadcast to BO, define clean BO chat ui update events with tool calls ([b90af31](https://github.com/saralufay/zaq/commit/b90af310bc7a3f3cc3bc1246087f020c21ab0604))
* **css:** prefix all foundation and semantic tokens with --zaq- ([8fe0cd2](https://github.com/saralufay/zaq/commit/8fe0cd2fb6d1ee73f459a1f9a3b90fb4a4fca013))
* **data source:** implement code changes to comply with code review ([a05bf13](https://github.com/saralufay/zaq/commit/a05bf13468f86a83629cdb4d2a72061ea3957049))
* **data source:** resolve integration module in bridge ([76c2ed9](https://github.com/saralufay/zaq/commit/76c2ed9e2b61d65b9ca45ae765ccb93de490f50a))
* **Endpoints:** enable channel specific routes ([40597f2](https://github.com/saralufay/zaq/commit/40597f234e2e38bd20d20249e768588df6dd9e6f))
* **ENV:** introduce new injectable Config module to load ENV and stabilize async tests ([a98cddd](https://github.com/saralufay/zaq/commit/a98cddd556fd8c029adf31f26c628efa5679da48))
* extract components from dashboard page ([a1e9195](https://github.com/saralufay/zaq/commit/a1e9195be0c8cae45a942997d06581fa0cb2edac))
* extract MapUtils, unify valid_rights contract, and add Action default callbacks via __using__ ([45edf8a](https://github.com/saralufay/zaq/commit/45edf8adedc65521192a423ffc2b77a956c9ea1d))
* fold Jido telemetry handlers into central bridge module ([f7bce06](https://github.com/saralufay/zaq/commit/f7bce06dd51e097f55cc1e66998ef099969b8ccb))
* Implement code review comments on channel's webhook ([49ffdde](https://github.com/saralufay/zaq/commit/49ffdde3fe9e956a6e3a843f3a4cbdea75fa4fc0))
* import dev.secret.exs at the end ([6e2f19f](https://github.com/saralufay/zaq/commit/6e2f19ffbcb7e21e5e490e2c23299f2dd4b294b4))
* **Ingestion:** convert Zaq local items to Record struct. Phase 1 of supporting multiple data sources for ingestion ([59a63ad](https://github.com/saralufay/zaq/commit/59a63ad4a549ae2dde29477a48424934ba855ba1))
* **ingestion:** drop chunk title column and title generation ([ed949b9](https://github.com/saralufay/zaq/commit/ed949b95ab7643981607c756246f839693aa16ee))
* **ingestion:** extract probe result helpers and bm25 query builder ([903e42a](https://github.com/saralufay/zaq/commit/903e42ae6e9edcf16750c2d30209c4490083fccc))
* **ingestion:** keep one path based on %Record{} and normalize at edges ([70b5a5e](https://github.com/saralufay/zaq/commit/70b5a5edec1cc45fc4ca141380e46cc314eb6940))
* **ingestion:** make directory rename DB updates atomic via Ecto.Multi ([6343212](https://github.com/saralufay/zaq/commit/6343212ff47e7eedf36b8b35202fec5841a5675f))
* **ingestion:** make pdf/docx/xlsx converters injectable for testing ([1924326](https://github.com/saralufay/zaq/commit/19243261508b336acf9d337633d5ec2d546e3df4))
* **ingestion:** normalize sidecar inside Record attributes, surface errors, specs and docs ([0a11227](https://github.com/saralufay/zaq/commit/0a11227c6f19c7eaf1e14036782fce8610547172))
* **live:** extract portal consent lifecycle and zaq provisioner into dedicated modules ([ae5b876](https://github.com/saralufay/zaq/commit/ae5b876d8aba0597fc8cd6b7cae8931f69121122))
* **live:** move portal provisioning to dedicated module and decouple consent modal ([7e2f819](https://github.com/saralufay/zaq/commit/7e2f819b5157930f2f614c3385ecb049caf7294c))
* **mix:** remove ex_dna not needed in mix q ([8a09c59](https://github.com/saralufay/zaq/commit/8a09c596c1dc21eab70e3028e3f21485f0701cd2))
* **NodeRouter:** deprecate call/ clauses ([c0a36dd](https://github.com/saralufay/zaq/commit/c0a36dd06250435b5ce8c49e99fc1a0af5bd1139))
* **onboarding:** centralize portal helpers and fetch metadata async ([dc6d7b3](https://github.com/saralufay/zaq/commit/dc6d7b33b5b248e162cd756a74bd01c67688db58))
* **onboarding:** register in zaq before provisioning portal ([7908c35](https://github.com/saralufay/zaq/commit/7908c35a032e0f4d32d40caf5bdada3bf1a0b18d))
* **onboarding:** unify blank?/1 helper and centralize portal client ([6d024aa](https://github.com/saralufay/zaq/commit/6d024aadfee59a4c79792f432aa7f1ce221a0a4d))
* **permission:** move Ingestion.Permission to Permissions.DocumentPermission ([cf9219c](https://github.com/saralufay/zaq/commit/cf9219c511e83cc7ee1043fa60ce33ec436ea7a4))
* remove code duplicates and optimize code performance ([0a2684a](https://github.com/saralufay/zaq/commit/0a2684aa349f49e3da64c2a6a4c2c93b692e2008))
* remove incoming concerns from server_manager, get history from Factory ([f3f8158](https://github.com/saralufay/zaq/commit/f3f8158aa202d95eb2f7ca99df3b338f7d21aa22))
* split concerns to inject figma script on dev only ([edb88e7](https://github.com/saralufay/zaq/commit/edb88e79917e009993c316179ff9cc8d8be00e9f))
* **storybook:** consolidate e2e tests and move storybook to dev ([e203baf](https://github.com/saralufay/zaq/commit/e203baf63c781b7a2463d0ab7c722e46dade18bf))
* **storybook:** consolidate e2e tests and move storybook to dev ([62a08ee](https://github.com/saralufay/zaq/commit/62a08ee6101ca099c327a75651ed1c60cc9a6f6a))
* **storybook:** move core_components and chat_message stories to legacy_ui/ ([9ab10aa](https://github.com/saralufay/zaq/commit/9ab10aab95ab099f26da8a516d1e0a84b3e9f896))
* **storybook:** rename text_styles story to text_styles_deprecated ([402bdeb](https://github.com/saralufay/zaq/commit/402bdeb771be3f07287cd7f3d493e46bdb983748))
* **storybook:** strip raw palette sections from colors story ([d27072f](https://github.com/saralufay/zaq/commit/d27072f7967cb45f9adbacd0daf33b8d8390d228))
* **System:** extract mcp, ai credentials and auth credentials into dedicated module files ([d39b28a](https://github.com/saralufay/zaq/commit/d39b28a77e63ba6ac2b051b858cdd750615ad6cd))
* **System:** extract remaining logic to keep routing only in system config live ([72e67ce](https://github.com/saralufay/zaq/commit/72e67ce797d806fd5548eaf4352ec64d663bdeea))
* **system:** send clear machine signals to portal without hashing ([3e207e0](https://github.com/saralufay/zaq/commit/3e207e0649f395b739b931a1a8d31972b1808ad4))
* **tools:** add output schema for tools for the workflow ([202fa9a](https://github.com/saralufay/zaq/commit/202fa9a6792b005ccaa8220e73e1a09200666bae))
* update sorting logic and add docs ([a55b272](https://github.com/saralufay/zaq/commit/a55b2720ed1799c6701ae370846cc509b89e47bd))
