defmodule ZaqWeb.CoreComponents do
  @moduledoc """
  ...
  This is intended for password/token fields where users may need to reveal
  the current value briefly.
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ZaqWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ZaqWeb.Gettext, "errors", msg, opts)
    end
  end
